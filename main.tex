...
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    \map{\pertype{article}\step[fieldset=type, fieldvalue=J]}
    \map{\pertype{inproceedings}\step[fieldset=type, fieldvalue=C]}
    \map{\pertype{incollection}\step[fieldset=type, fieldvalue=C]}
    \map{\pertype{book}\step[fieldset=type, fieldvalue=M]}
    \map{\pertype{thesis}\step[fieldset=type, fieldvalue=D]}
    \map{\pertype{patent}\step[fieldset=type, fieldvalue=P]}
  }
}
